          ...
          {data && (
            <>
              <div className="flex items-center gap-3 mb-4">
                ...
                <div className="min-w-0">
                  <div className="text-lg font-extrabold text-warm-800 truncate">{data.recipient_name}</div>
              ...
              {data.matched_caregiver && (
                <div className="rounded-lg border border-brand-200 bg-brand-50/50 px-4 py-3 mb-4 flex items-center gap-2 text-sm">
                  <BadgeCheck className="w-4 h-4 text-brand-500" />
